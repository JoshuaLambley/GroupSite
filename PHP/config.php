...
$CFG->base_url = 'https://preney.myweb.cs.uwindsor.ca/provided/';
...
$CFG->db_dsn = 'mysql:host=localhost;dbname=lambley_project';
$CFG->db_user='lambley_project';
$CFG->db_pass='TFw8gQpo2Q';
